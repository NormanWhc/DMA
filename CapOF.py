...
def fitting(train_p, test_p, train_d, test_d, train_y, test_y, model_type, lr, ep, sl, path, taxonomy,dti, batchsize=64):
    ...
    if "onehot_fingerprint_capsule" in model_type:
        param_grid = {
            "target_dense": [200],
            "batch_size": [64],
            "seq_len": sl,
                                ...
                                for num_capsule in param_grid["num_capsule"]:
                                    for routings in param_grid["routings"]:
                                        for kernel_size in param_grid["kernel_size"]:
                                            ...
                                            param = {"target_dense": target_dense, "drug_dense": target_dense,"seq_len":sl,"num_capsule":num_capsule,"routings":routings,"kernel_size":kernel_size}
                                            model_1 = model_onehot_fingerprint_capsule(param=param)
