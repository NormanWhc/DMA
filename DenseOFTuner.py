...
def fitting(train_p, test_p, train_d, test_d, train_y, test_y, model_type, lr, ep, sl, path, taxonomy,dti, batchsize=64):
    ...
    if "onehot_fingerprint_dense" in model_type:
        ...
        #     tuner = kt.Hyperband(
        #         model_onehot_fingerprint_dense_tuner,
        #         objective='accuracy',
        #         max_epochs=1000,
        #         factor=3,
        #         directory='my_dir',
        ...
        #     tuner.search([train_p_train,train_d_train],train_y_train, epochs=ep,
...
if __name__ == '__main__':
    ...
    fitting(train_p, test_p, train_d, test_d, train_y, test_y, model_name, learning_rate, n_epoch, protein_sequence_length, ".", model_name, batchsize=batch_size)
